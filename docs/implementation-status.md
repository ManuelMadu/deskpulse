...
**DP-7 — Supervisor happy path** (Phase 2): spawn with env token, handshake parse + `/health` confirm ≤ 10 s, SIGTERM on quit with 5 s SIGKILL fallback; unit tests for handshake parser; E2E smoke asserting no orphan after quit.
