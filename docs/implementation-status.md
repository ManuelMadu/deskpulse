...
**DP-6 — Agent lifecycle**: formal stdout ready-handshake schema, SIGTERM graceful shutdown ≤ 3 s, exit-code conventions (78 no-token, 71 listen-fail), pino file logging with size rotation; integration tests for each.
